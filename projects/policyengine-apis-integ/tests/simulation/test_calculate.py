...
def test_calculation(client: policyengine_simulation_api_client.DefaultApi):
    options = policyengine_simulation_api_client.SimulationOptions(
            ...
            data=policyengine_simulation_api_client.Data("gcs://policyengine-us-data/cps_2023.h5") # force the service to use google storage (policyengine.py defaults to huggingface)
        )
