...
from policyengine_api_simulation.simulation_macro_output import GeographicImpactOutput
from policyengine_api_simulation.simulation_output_common import (
    _output_model_dump,
