...
class TestSubmitSimulationEndpoint:
    ...
    def test__given_submission_with_data__then_returns_resolved_bundle_metadata(
        ...
        request_body = {
            ...
            "scope": "macro",
            "reform": {},
            "data": "hf://policyengine/policyengine-us-data/enhanced_cps_2024.h5@1.115.3",
        }
        ...
        assert data["policyengine_bundle"] == {
            ...
            "dataset": "hf://policyengine/policyengine-us-data/enhanced_cps_2024.h5@1.115.3",
        }
    ...
    def test__given_submission_with_alias_data__then_bundle_dataset_stays_unresolved(
        ...
        assert (
            ...
            == "hf://policyengine/policyengine-us-data/enhanced_cps_2024.h5@1.115.3"
        )
